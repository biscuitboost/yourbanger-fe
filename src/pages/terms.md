...
**What we don't promise:** Your song will win a Grammy. It's AI-generated and meant for personal enjoyment, not professional music production.
...
**Your content:** The personal information you provide (names, stories, details) belongs to you. We just use it to create your song.

**The songs:** You have the right to use songs you create for personal purposes. Share them, download them, play them at parties - go wild.

**Commercial use:** If you want to use a song commercially (in a video you're selling, as part of a product, etc.), contact us first. We'll probably say yes, but we need to know.

## 6. What You Can't Do

Don't be a jerk. Specifically:

- Don't create offensive, harmful, or illegal content
- Don't try to hack, break, or abuse the service
- Don't impersonate others or violate anyone's rights
...
Our songs are created using AI. Sometimes AI does weird things. We review the output, but we can't catch everything.

If your song has something unexpected or problematic, let us know and we'll regenerate it for free. We're not trying to create issues - we're trying to create laughs.

## 8. Service Changes & Availability

We might update features, change pricing, or modify how the service works. We'll let you know about major changes.

Sometimes the service might be down for maintenance or because the internet gremlins attacked. We'll fix it as fast as we can.

## 9. Limitation of Liability

(This is the part lawyers make us write)
...
We might update these terms occasionally. We'll let you know about major changes via email or a notification on the site. Continued use of the service means you accept the new terms.

## 12. Governing Law

These terms are governed by the laws of Scotland, UK. Any disputes will be resolved in Scottish courts.

## 13. Contact Us

Questions about these terms? Something not clear? Spotted a typo?

**Email us at:** legal@yourbanger.com
